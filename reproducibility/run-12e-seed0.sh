#!/usr/bin/env bash
set -euo pipefail
# 12e seed0: six-question reference; fresh initial research plus all six questions.
# One H100, no history, descriptive titles;123904full-path maximumtokens. No automatic launch.
mode=(--validate-only)
run_id='germanwiki-6-012e-fp8-20260914-seed0-concurrent-12e'
run_id_set=false
...
exec uv run --frozen python -m orchestrator.simulated_web.modal_hf_reference_12e \
