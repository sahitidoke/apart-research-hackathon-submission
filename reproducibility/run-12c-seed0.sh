#!/usr/bin/env bash
set -euo pipefail
# 12c seed0: six-question reference; fresh initial research plus all six questions.
# One H100, no history, own-only notebooks;123904full-path maximumtokens. No automatic launch.
mode=(--validate-only)
run_id='germanwiki-6-012c-fp8-20260913-seed0-answer600-v3-concurrent-12c'
run_id_set=false
...
exec uv run --frozen python -m orchestrator.simulated_web.modal_hf_reference_12c \
